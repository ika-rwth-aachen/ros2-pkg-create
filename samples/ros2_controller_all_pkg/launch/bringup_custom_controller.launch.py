        ...
        actions=[
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    [
                        str(Path(get_package_share_directory("ros2_controller_all_pkg")) / "launch" / "custom_controller.launch.py"),
                    ]
                ),
            ),
        ],
    ...
    controller_manager_launch = GroupAction(
        actions=[
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    [
                        str(Path(get_package_share_directory("ros2_controller_all_pkg")) / "launch" / "controller_manager.launch.py"),
                    ]
                ),
            ),
        ],
    ...
    robot_description_launch = GroupAction(
        actions=[
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    [
                        str(Path(get_package_share_directory("ros2_controller_all_pkg")) / "launch" / "robot_description.launch.py"),
                    ]
                ),
                launch_arguments={
